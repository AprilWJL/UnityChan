...
public class LevelGenerator : EditorWindow 
{
	...
	void Generate()
	{
		...
		for(int ty=0; ty<colorMap.GetLength(1) ; ty++) // read the colors in the color map in the Y axix
			{			
				...
				{
					instPos = new Vector3((tx)*spaceX, 0, (ty)*spaceY); // set the object's position based in the color position in the tale
	...
	{	
        ...
        spaceY = EditorGUILayout.FloatField("SpaceY: ", spaceX);
