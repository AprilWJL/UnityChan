...
function PickUpItem ()
{
	...
	var pickup : FirstPersonPickUp = GetComponent(FirstPersonPickUp);
...
function MoveMeToThePlayer(itemHolderObject : Transform)
{
	...
	for(var renderer : MeshRenderer in GetComponentsInChildren(MeshRenderer)){
	...
	for(var collider : Collider in GetComponentsInChildren(Collider)){
		collider.enabled = false;
	}

	for(var rigid : Rigidbody in GetComponentsInChildren(Rigidbody)){
		//rigid.enabled = false;
